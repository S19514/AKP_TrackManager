...
{
    public partial class AKP_TrackManager_Context : DbContext
    {
        public AKP_TrackManager_Context()
        {
        }

        public AKP_TrackManager_Context(DbContextOptions<AKP_TrackManager_Context> options)
            : base(options)
        {
        }
